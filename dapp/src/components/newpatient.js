				...
				<div id="addpatient">
					 ...
					 <div className="form-group" >
					  ...
					  <button onClick={async(event) => {
					  	...
					  	await contract.methods.addPatientInfo(this.state.acn,this.state.name,this.state.home,this.state.no,this.state.bg,this.state.icid,this.state.emer).send({from : accounts[0],gas : 1000000});
